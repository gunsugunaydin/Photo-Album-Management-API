...
Alternatively, you can open the repository directly in VS Code using the following trick: simply prepend <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/9/9a/Visual_Studio_Code_1.35_icon.svg/512px-Visual_Studio_Code_1.35_icon.svg.png?20210804221519" alt="Waving Hand" width="18" height="18">  `https://vscode.dev/` to the repository URL. For example: https://vscode.dev/github.com/gunsugunaydin/Photo-Album-Management-API
...
<img src="https://media.tenor.com/beCXMoxigz4AAAAM/rosycheeks-mochi-peach.gif" alt="Waving Hand" width="43" height="43"> Get in Touch:
